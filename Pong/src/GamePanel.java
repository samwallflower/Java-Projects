...
public class GamePanel extends JPanel implements Runnable{
    ...
    public void paint(Graphics g){
        ...
        draw(graphics);
        g.drawImage(image,0,0,this);//this = jpanel called game panel
    ...
    public void checkCollision(){
        ...
        if(ball.intersects(paddle1)){
            ...
            if(ball.yVelocity>0)
                ...
                ball.yVelocity--;//goin upwards we're increasing upward velocity
        ...
        if(ball.x <=0){
            //the ball is out of the right window boundary
            score.player2++;
            newPaddles();
            newBall();
